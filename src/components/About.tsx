    ...
    <section id="about" className="section-padding bg-accent/10">
      <div className="max-w-4xl mx-auto">
        <div className="animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-reveal">Education & Background</h2>

          <div className="space-y-12 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="animate-on-scroll hover-lift" style={{ '--index': 0 } as React.CSSProperties}>
                <h3 className="text-xl font-semibold mb-2 scale-in">Master of Technology</h3>
              ...
              <div className="animate-on-scroll hover-lift" style={{ '--index': 1 } as React.CSSProperties}>
                <h3 className="text-xl font-semibold mb-2 scale-in">Bachelor of Engineering</h3>
          ...
          <div className="prose prose-lg dark:prose-invert fade-in">
            <p>
